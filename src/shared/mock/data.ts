...
const SUBS = ['ООО «Газпромнефть-Региональные продажи»', 'ООО «Газпромнефть-Логистика»', 'ООО «Газпромнефть — смазочные материалы»', 'ООО «Газпромнефть-Снабжение»', 'ООО «Газпромнефть-Аэро»'];
