...
export function buildExternal(cp: Counterparty) {
  ...
  return {
    sections: [
      { key: 's1', title: '1. Финансовые индикаторы риска СПАРК', indicators: section1 },
      { key: 's2', title: '2. Риск-индикаторы по данным СПАРК', indicators: section2 },
      { key: 's4', title: '4. Внешние рейтинги и оценки', indicators: section4 },
      { key: 's5', title: '5. Риск-индикаторы по данным ФНС', indicators: section5 },
      { key: 's6', title: '6. Судебные дела / Исполнительные производства / Залоги', indicators: section6 },
      { key: 's7', title: '7. Реестр недобросовестных поставщиков (РНП)', indicators: section7 },
      { key: 's9', title: '9. Реестры государственных служб', indicators: section9 },
      { key: 's10', title: '10. Налоги и взносы', indicators: section10 },
      { key: 's11', title: '11. Признаки хозяйственной деятельности', indicators: section11 },
    ] as ExternalSection[],
    sanctions,
    courtCases,
  };
